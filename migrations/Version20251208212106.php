 ...
 */
final class Version20251208212106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement_ecologique (id INT AUTO_INCREMENT NOT NULL, id_organisateur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_debut VARCHAR(255) NOT NULL, date_fin VARCHAR(255) NOT NULL, lieu VARCHAR(255) NOT NULL, capacite_max INT NOT NULL, categorie VARCHAR(255) NOT NULL, INDEX IDX_AB3086B330687172 (id_organisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
